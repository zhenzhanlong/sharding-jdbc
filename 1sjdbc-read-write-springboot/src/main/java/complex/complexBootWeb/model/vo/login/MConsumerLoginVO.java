 ...
 *
 */
public class MConsumerLoginVO implements Serializable {
	/**
	 * 序列化
	 */
	...
	public MConsumerLoginVO() {
		super();
	}

	public MConsumerLoginVO(Long consumer_id) {
		super();
		this.consumer_id = consumer_id;
	}

	public MConsumerLoginVO(Long consumer_id, String consumer_name) {
		super();
		this.consumer_id = consumer_id;
